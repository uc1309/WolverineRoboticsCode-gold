...
public class Camera extends Subsystem {
	...
	public class Scores {
		...
		public double LongAspect;
		public double ShortAspect;
		public double AreaToConvexHullArea;
	};
	...
	//Constants
	public NIVision.Range TOTE_HUE_RANGE = new NIVision.Range(24, 49);	//Default hue range for yellow tote
	public NIVision.Range TOTE_SAT_RANGE = new NIVision.Range(67, 255);	//Default saturation range for yellow tote
	public NIVision.Range TOTE_VAL_RANGE = new NIVision.Range(49, 255);	//Default value range for yellow tote
	public double AREA_MINIMUM = 0.5; //Default Area minimum for particle as a percentage of total image area
	public double LONG_RATIO = 2.22; //Tote long side = 26.9 / Tote height = 12.1 = 2.22
	public double SHORT_RATIO = 1.4; //Tote short side = 16.9 / Tote height = 12.1 = 1.4
	public double SCORE_MIN = 75.0;  //Minimum score to be considered a tote
	public double VIEW_ANGLE = 49.4; //View angle fo camera, set to Axis m1011 by default, 64 for m1013, 51.7 for 206, 52 for HD3000 square, 60 for HD3000 640x480
